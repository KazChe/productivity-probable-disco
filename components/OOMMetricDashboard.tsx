...
const chartData = [
  {
    day: "Monday",
    ooms: 5,
    instances: { "unicorn-sparkle": 2, "dragon-breath": 3 },
  },
  {
    day: "Tuesday",
    ooms: 8,
    instances: { "pixie-dust": 5, "mermaid-scale": 3 },
  },
  {
    day: "Wednesday",
    ooms: 3,
    instances: { "wizard-whisker": 2, "phoenix-feather": 1 },
  },
  {
    day: "Thursday",
    ooms: 6,
    instances: { "goblin-gold": 2, "fairy-floss": 4 },
  },
  { day: "Friday", ooms: 4, instances: { "troll-toe": 2, "elf-ears": 2 } },
  {
    day: "Saturday",
    ooms: 2,
    instances: { "centaur-hoof": 1, "griffin-claw": 1 },
  },
  ...
  return (
    <div className="flex gap-4">
        ...
        <Card className="bg-gray-800 text-white-100">
          ...
          <CardFooter className="flex-col items-start gap-2 text-sm">
            <div className="flex gap-2 font-medium leading-none">
              Trending up/down by xx% this week{" "}
      ...
      <div className="w-1/2">
        <Card className="bg-gray-800 text-white-100">
          <CardHeader>
            <CardTitle>OOM Metrics</CardTitle>
          </CardHeader>
            ...
            <Accordion type="single" collapsible className="w-full">
              {chartData.map((day) => (
                <AccordionItem key={day.day} value={day.day}>
                  ...
                  <AccordionContent>
                    {Object.entries(day.instances).map(
                      ([instance, count], index, array) => (
